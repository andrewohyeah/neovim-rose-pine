...
function M.get(config)
	...
	theme = {
		...
		-- Cursor = {},
		CursorColumn = { bg = config.groups.cursor or p.highlight_low },
		-- CursorIM = {},
		CursorLine = { bg = config.groups.cursor or p.highlight_low },
		...
		Conditional = { fg = p.pine, style = styles.bold },
		Constant = { fg = p.love },
		Debug = { fg = p.rose },
		Define = { fg = p.iris },
		...
		Exception = { fg = p.pine },
		Float = { fg = p.love },
		Function = { fg = p.highlight_high },
		Identifier = { fg = p.rose },
		-- Ignore = {},
		Include = { fg = p.iris, style = styles.bold },
		Keyword = { fg = p.highlight_high, style = styles.bold },
		Label = { fg = p.foam },
		Macro = { fg = p.iris },
		Number = { fg = p.love },
		Operator = { fg = p.iris },
		PreCondit = { fg = p.iris },
		PreProc = { fg = p.iris },
		Repeat = { fg = p.pine, style = styles.bold },
		Special = { fg = p.rose },
		...
		Tag = { fg = p.rose },
		Todo = { fg = p.iris },
		Type = { fg = p.muted, style = styles.bold },
		Typedef = { fg = p.rose },
		...
		TSAttribute = { fg = p.highlight_high },
		...
		TSConstructor = { fg = p.muted, style = styles.bold },
		-- TSEmphasis = {},
		-- TSError = {},
		-- TSException = {},
		--TSField = { fg = p.foam },
		--TSField = { fg = p.muted, style = 'NONE' },
		TSField = { fg = p.highlight_high },
		-- TSFloat = {},
		TSFuncBuiltin = { fg = p.love },
		-- TSFuncMacro = {},
		TSMethod = { fg = p.highlight_high, style = styles.bold },
		TSFunction = { fg = p.highlight_high, style = styles.bold },
		TSInclude = { fg = p.iris, style = styles.bold },
		TSKeyword = { fg = p.highlight_high, style = styles.bold },
		TSKeywordFunction = { fg = p.subtle, style = styles.bold },
		TSKeywordOperator = { fg = p.iris, style = styles.bold },
		TSLabel = { fg = p.foam },
		-- TSLiteral = {},
		-- TSMethod = {},
		-- TSNamespace = {},
		...
		TSOperator = { fg = p.muted, style = styles.bold },
		TSParameter = { fg = p.subtle, style = styles.italic },
		-- TSParameterReference = {},
		TSProperty = { fg = p.subtle },
        TSPunctBracket = { fg = groups.punctuation },
		--TSPunctBracket = { fg = p.love },
		...
		TSType = { link = 'Type' },
		TSTypeBuiltin = { fb = p.muted, style = styles.bold, },
		-- TSTypeBuiltin = {},
		TSURI = { fg = groups.link },
		-- TSUnderline = {},
		--TSVariable = { fg = p.text, style = styles.italic },
		TSVariable = { fg = p.subtle, style = styles.bold },
		TSVariableBuiltin = { fg = p.muted, style = styles.bold },
